  ...
  return (
    ...
    >
      ...
      <div style={{marginBottom:14}}>
		...
		{error&&<div style={{padding:'9px 11px',color:'var(--err)',border:'1px solid color-mix(in oklch,var(--err) 35%,var(--line))',borderRadius:5,marginBottom:12}}>{error}</div>}
...
// ── Export ────────────────────────────────────────────────────────────────────
window.DockerLegacyTabs = { images: DockerImages, networks: DockerNetworks, volumes: DockerVolumes, templates: DockerTemplates };
window.DockerNewContainer = NewContainerDialog;
