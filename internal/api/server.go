...
func (s *Server) routes() {
	...
	// storage
	a("/api/storage/jobs", s.handleDiscJobs)
	a("/api/storage/jobs/", s.handleDiscJobs)
	a("/api/storage/jobs-health", s.handleDiscHealth)
	...
	a("/api/storage/rescan", s.discOperation("rescan"))
	a("/api/storage/mounts", s.handleMounts)
	a("/api/storage/pools", s.handleStoragePools)
	a("/api/mounts", s.handleMounts)
	a("/api/storage/mount", s.discOperation("mount"))
	a("/api/storage/unmount", s.discOperation("unmount"))
	a("/api/storage/format", s.discOperation("format"))
	a("/api/storage/fstab", s.handleStorageFstab)
	a("/api/storage/fstab-content", s.handleStorageFstabContent)
	a("/api/storage/save-fstab", s.discOperation("fstab.save"))
	a("/api/storage/edit-fstab", s.discOperation("fstab.save"))
	...
	a("/api/storage/scan-lvm", s.discOperation("lvm.scan"))
	a("/api/storage/raid", s.handleStorageRAID)
	a("/api/storage/raid/start", s.handleStorageRAIDStart)
	a("/api/storage/scan-raid", s.discOperation("raid.scan"))
	a("/api/storage/create-raid", s.discOperation("raid.create"))
	...
	a("/api/zfs/snapshots/", s.handleDiscSnapshot)
	...
	// ZFS pool create
	a("/api/zfs/pool/create", s.discOperation("zfs.create"))
